...
function get_individual_cast(movie_cast, my_api_key) {
    ...
    for (var cast_id in movie_cast.cast_ids){
        $.ajax({
            ...
            error: function() {
                alert("Get Indoviduals Cast Error!");
...
// Mendapatkan semua detail cast untuk film yang diminta
...
// Mendapatkan semua poster film yang direkomendasikan
...
// Memindahkan semua detail ke python's flask untuk ditampilkan dan mengambil ulasan film menggunakan id imdb
...
// Mendapatkan semua detail film menggunakan id film.
...
// Memindahkan nama film untuk mendapatkan film serupa dari python's flask
...
// Mendapatkan detail dasar film dari API (berdasarkan nama film)
...
// Tombol akan dinonaktifkan sampai kita mengetik sesuatu di dalam kolom input
$(function() {
